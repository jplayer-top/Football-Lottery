package top.jplayer.baseprolibrary.widgets.nineimageview;
 ...
 * NineGridImageView nineGrid = helper.itemView.findViewById(R.id.nineGrid);
        ...
        return super.generateImageView(context);
         ...
         for (HomeFamilyListBean.FamiliesBean.UsersBean user : item.users) {
         list.add(user.avatar);
         }
         nineGrid.setAdapter(adapter);
         nineGrid.setImagesData(list);
 */
